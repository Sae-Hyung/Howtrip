...
<head>
    ...
    <script src="https://openapi.map.naver.com/openapi/v3/maps.js?pgm7xqwnxu"></script>
</head>
<body>
    <div id="map"></div>
    <script>
        ...
        async function fetchTouristSpots(pageNo = 1) {
            ...
            const url = `https://apis.data.go.kr/B551011/KorService1/areaBasedList1?serviceKey=${apiKey}&numOfRows=100&pageNo=${pageNo}&MobileOS=ETC&MobileApp=AppTest&arrange=A&contentTypeId=12`;
